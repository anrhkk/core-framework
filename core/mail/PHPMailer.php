 ...
 */
    ...
    public function HasMultiBytes($str)
    {
        ...
        } else { // Assume no multibytes (we can't handle without mbstring Function anyway)
            return false;
        }
    }
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        $DKIMtime = NOW; // Signature Timestamp = seconds since 00:00:00 - Jan 1, 1970 (UTC time zone)
