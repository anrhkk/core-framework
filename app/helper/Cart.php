...
class Cart
{
     ...
     * 统计购物车中商品数量
     */
    public static function getTotalNums()
    {
        $goods = self::getGoods(); //获得商品数据
        $rows = 0;
        foreach ($goods as $v) {
    ...
    {
        return Request::session(self::cartName);
    }
    ...
    public static function getOrderId()
    {
        ...
        substr(NOW, -5) . substr(microtime(), 2, 5) . str_pad(mt_rand(1, 99), 2, '0', STR_PAD_LEFT);
    }
}