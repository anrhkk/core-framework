...
class Str
{
    ...
    {
        $charset = is_null($charset) ? preg_replace("/utf-8|utf8/i", "UTF-8", config('CHARSET')) : $charset;
    ...
    {
        $string = self::toSemiangle($string);
        $preg = "/[,.!;:<>\?'\"@#$%^&*\(\)\-_\+=\|\\\{\}\[\]\/`]/i";
     ...
     * 字符串截取，支持中文和其他编码
     */
    public static function msubstr($str, $start = 0, $length = 20, $suffix = true)
    {
